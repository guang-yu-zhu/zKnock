...
#' 
#' @details This function uses the `glmnet` package to fit the penalized logistic regression path
...
#' res = knockoff.filter(X,y,Xk,statistic = stat.lasso_coefdiff_bin)
#' res$s
#' 
